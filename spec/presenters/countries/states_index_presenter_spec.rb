...
RSpec.describe Countries::StatesIndexPresenter do
  describe "#states" do
    context "when the there are states in given country" do
    ...
    context "when the there are NO states in given country" do
      it "presents a State.blank" do
        country = create(:country)
        another_country = create(:country)
        another_state = create(:state, country: another_country)
        presenter = Countries::StatesIndexPresenter.new(country: country)

...
RSpec.describe Projects::QuestionsIndexPresenter do
  ...
  describe "#questions_by_reserve" do
    ...
    it "returns only reserve questions involving what the project involves" do
      ...
      ignoring_question = create(:reserve_question, reserve: reserve, ignore_involvements: true)
      ...
      create(:project_reserve_answer, project: project, reserve_question: ignoring_question)

...
RSpec.describe Manager::ReserveInfo::ReserveFormPresenter do
  ...
  describe "#logo" do
    it "presents placeholder image if no logo is attached" do
      ...
      expect(presenter.logo).to eq("ucnature-logo.png")
    end
  ...
  describe "#hero_photo" do
    ...
    it "presents the correct avatar path if large_hero_photo is attached" do
      ...
      expect(presenter.hero_photo).to match(/\/small_test-image.jpeg/)
    end
  end
  ...
  describe "#listing_photo" do
    ...
    it "presents the correct avatar path if listing_photo is attached" do
      ...
      expect(presenter.listing_photo).to match(/\/small_test-image.jpeg/)
    end
  end
end

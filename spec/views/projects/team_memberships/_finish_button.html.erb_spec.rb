...
RSpec.describe "app/views/projects/team_memberships/_finish_button.html.erb" do
  it "renders a button that links to the project summary page" do
    project = build_stubbed(:project)
    presenter = OpenStruct.new(project: project)

    render partial: "projects/team_memberships/finish_button", locals: { presenter: presenter }

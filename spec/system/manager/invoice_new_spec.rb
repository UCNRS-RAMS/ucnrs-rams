...
RSpec.describe "Invoice New" do
  ...
  describe "it display amenity visits" do
    ...
    it "on change arrives date subtotal, total and days will change", js: true do
      ...
      amenity_visit_one = create(:amenity_visit, visit: visit, number_of_people: 10, rate: 10, arrives: visit.starts_at, departs: visit.ends_at, amenity: amenity, amenity_rate_id: amenity_rate.id)

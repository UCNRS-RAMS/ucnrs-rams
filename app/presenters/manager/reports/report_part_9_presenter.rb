class Manager::Reports::ReportPart9Presenter < Manager::Reports::ReportBasePresenter
  def report_part9_data
    report_part9_data_scope
      .map { |project| Manager::Reports::ReportPart9::ProjectPresenter.new(project: project, start_date: start_date, stop_date: stop_date,) }
  ...
  def fiscal_year_select_path
    :report_part_9_manager_reserve_report_path
  end

  def report_part9_data_scope
    Project
      .select("
        projects.*,
